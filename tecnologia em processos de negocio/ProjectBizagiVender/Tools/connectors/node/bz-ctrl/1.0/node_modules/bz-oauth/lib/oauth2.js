...
exports.OAuth2.prototype.clientCredentialsFlow= function(token_url, client_id, client_secret, scope, params, headers, callback) {    
    var headers = headers || {};
    var params= params || {};
    ...
    this._request("POST", token_url, headers, post_data, null, function(error, data, response) {
        if( error ){              
...
exports.OAuth2.prototype.resourceOwnerPasswordCredentialsFlow= function(token_url, username, password, scope, params, headers, callback) {    
    var headers = headers || {};
    var params= params || {};
