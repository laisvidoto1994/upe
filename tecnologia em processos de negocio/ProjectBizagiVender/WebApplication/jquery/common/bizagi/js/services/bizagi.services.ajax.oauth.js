...
var jqOAuth = function jqOAuth(options) {
    ...
    if (this._hasStoredData()) {
        ...
        if (this.hasAccessToken()) {
            this.login(this.data.access_token, this.data.refresh_token);
        }
    } else {
        this._resetData();
        this._updateStorage();
    ...
    if (typeof options.csrfToken != "undefined" &&  options.csrfToken !== null) {
        this._setCsrfHeader();
    }
}
...
jqOAuth.prototype._getStoredData = function _getStoredData() {
    $.extend(this.data, JSON.parse(localStorage.getItem(this.options.tokenName)));
};
...
jqOAuth.prototype._hasStoredData = function _hasStoredData() {
    return (typeof localStorage.getItem(this.options.tokenName) !== "undefined" && localStorage.getItem(this.options.tokenName) !== null);
};
...
jqOAuth.prototype._setAuthorizationHeader = function _setAuthorizationHeader() {
    this._setAjaxHeader("Authorization", "Bearer " + this.data.access_token);
};
...
jqOAuth.prototype._updateStorage = function _updateStorage() {
    if (this.data.access_token !== null && typeof this.data.access_token !== "undefined"){
        localStorage.setItem(this.options.tokenName, JSON.stringify(this.data));
    }else{
