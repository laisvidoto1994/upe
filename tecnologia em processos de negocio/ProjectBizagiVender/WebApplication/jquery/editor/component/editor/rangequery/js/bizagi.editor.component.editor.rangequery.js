/*
@title: Editor rangequery
@authors: Rhony Pedraza
@date: 28-aug-2012
*/
bizagi.editor.component.editor(
    "bizagi.editor.component.editor.rangequery", {
        ...
        renderEditor : function(container, data) {
            ...
            $.extend(data, {
                uiValues: [
                {
                    label: bizagi.localization.getResource("formmodeler-component-editor-rangequery-from"),
                    value: "from",
                    style: "bz-studio bz-range-query-from_16x16_standard"
        },
                    {
                        label : bizagi.localization.getResource("formmodeler-component-editor-rangequery-to"),
                        value: "to",
                        style: "bz-studio bz-range-query-to_16x16_standard"
                    },
                    {
                        label: bizagi.localization.getResource("formmodeler-component-editor-rangequery-none"),
                        value: "none",
                        style: " bz-studio bz-number-range_16x16_standard"
                    }
                ],
                valueCheck : false
            });
            ...
            if(self.inline){
                elEditor.addClass('bizagi-editor-rangequery-inline');
            }
        ...
        loadTemplates : function() {
            ...
            $.when(
                this.loadTemplate("frame", bizagi.getTemplate("bizagi.editor.component.editor.rangequery").concat("#rangequery-frame"))
            ).done(function() {
                deferred.resolve();
            });
