...
s = 0.25 #suporte com nivel de ex: 25%
c = 0.8 #confiança com nivel de ex: 80%

#Conjunto de transacoes dos dados
transacoes = {  
...
#Imprime as regras de associacao de acordo com o suporte e confianca
print(" ------ ")
