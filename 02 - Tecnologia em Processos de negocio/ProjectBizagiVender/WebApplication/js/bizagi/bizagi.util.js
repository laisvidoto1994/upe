...
/*
* BizAgi Util
* * Defines a series of helpers and objects addins to help all the bizagi javascript engine
...
function encodeXpath(xpath) {
    return xpath.replaceAll(".", "_");
}

/* Path join method*/
function urlMergeQueryString(path, querystring) {
    if (path.indexOf("?") == -1) {
...
/* Converts a percent into a numer*/
