...
bizagi.initializeWorkportal = function (params) {
    ...
    loader.init({
	    ...
	    loader.loadFile(bizagi.getJavaScript("bizagi.sharepoint.internals.overrides"), bizagi.getJavaScript("bizagi.sharepoint.overrides"), bizagi.getJavaScript("bizagi.workportal.internals.desktop.overrides"), bizagi.getJavaScript("bizagi.workportal.desktop.overrides"));
            ...
            loader.then(function () {
                ...
                // Get user language
                $.when(bizagi.getUserSettings(params))
				.pipe(function (data) {
				    if (data) {
