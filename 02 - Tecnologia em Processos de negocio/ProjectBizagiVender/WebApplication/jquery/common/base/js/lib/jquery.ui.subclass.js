// Code to allow widget inheritance in a easy way
var object = (function () { function F() { } return (function (o) { F.prototype = o; return new F(); }); })();
$.widget('ui.widget', $.widget);

var OVERRIDE = /xyz/.test(function () { xyz; }) ? /\b_super\b/ : /.*/;
$.ui.widget.subclass = function subclass(name) {
    $.widget(name, $.widget); // Slightly inefficient to create a widget only to discard its prototype, but it's not too bad
    name = name.split('.');
    var widget = $[name[0]][name[1]], superclass = this, superproto = superclass.prototype;
    var widgetDefaults = {
        namespace: widget.prototype.namespace,
        widgetName: widget.prototype.widgetName,
        widgetEventPrefix: widget.prototype.widgetEventPrefix,
        widgetBaseClass: widget.prototype.widgetBaseClass
    };
    ...
    $.extend(true, proto, widgetDefaults);
    var _init = proto._init;
    proto._init = function () {
        this.element.data(widget.prototype.widgetName.toLowerCase(), this);
        this.element.data(widget.prototype.widgetName, this);
        if (proto.hasOwnProperty('_init')) _init.apply(this);
    };

    proto.bindEvent = function(eventName, callback){
        var self = this;
    ...
    for (key in proto) if (proto.hasOwnProperty(key)) switch (key) {
        ...
        case 'destroy':
            ...
            proto.destroy = function () {
                // Remove data set in init
                this.element.removeData(widget.prototype.widgetName.toLowerCase());
                this.element.removeData(widget.prototype.widgetName);
