...
describe('Test workportal-rendering loader', function () {
    ...
    it('Testing if was crated rendering object', function(done){
        ...
        dependencies.dataService = new bizagi.render.services.service();
        dependencies.renderFactory = new bizagi.rendering.smartphone.factory(dependencies.dataService);
