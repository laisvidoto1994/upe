...
bizagi.rendering.image.extend("bizagi.rendering.image", {
    ...
    configureHandlers: function() {
        ...
        if (this.isNative) {
            ...
            this.$addImage.click(function() {
                ...
                modal.find(".bz-wp-modalview-close").bind("click", function() {
                    //noinspection JSUnresolvedFunction
                    modal.kendoMobileModalView("close");
                });
        ...
        // Just in case
        this.$inputFile.on("click", function(e) { e.stopPropagation(); });

        this.getControl().find("img").click(function() { self.renderEdition(); });
    ...
    createModal: function() {
        ...
        var modalViewTemplate = kendo.template(self.renderFactory.getTemplate("imageModalView"),
        { useWithBlock: false });
