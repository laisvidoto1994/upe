...
(function (window, $, undefined) {
        ...
        return [
            "<div class='sp-container'>",
                ...
                "<div class='sp-picker-container'>",
                    ...
                    "<div class='sp-button-container sp-cf  biz-actions-bar'>",
                        "<a class='sp-cancel biz-btn biz-action-btn' href='#'></a>",
                        "<a class='sp-choose biz-btn biz-action-btn' href='#'></a>",
                    "</div>",
                "</div>",
            "</div>"
        ].join("");
    ...
    paletteTemplate = function (p, color, className) {
        ...
        for (var i = 0; i < p.length; i++) {
            ...
            if(tinycolor.equals(color, p[i])){
                spanClassName += "sp-thumb-active ";
            }
        
            var nColor = '';

            if(p[i] === 'transparent'){
                nColor =  tiny.toRgbString();
                nTitle = p[i];
                spanClassName += "sp-thumb-transparent sp-thumb-light ";
            }else{
                nColor = nTitle = tiny.toHexString();
                spanClassName += tiny.toHsl().l < .5 ? "sp-thumb-dark " : "sp-thumb-light ";
            }

            html.push('<span title="' + nTitle + '" data-color="' + nColor + '" style="background-color:' + tiny.toRgbString() + ';" class="' + spanClassName + '"></span>');
        }
    ...
    function spectrum(element, o) {
        ...
        var opts = instanceOptions(o, element),
            ...
            cancelResponse = (opts.cancelResponse)? opts.cancelResponse : false;
        ...
        function initialize() {
            ...
            cancelButton.bind("click", function (e) {
                ...
                if(cancelResponse){
                    flat = false;
                    cancelResponse.apply(this, [{instance:this, destroy:destroy, hide:hide}]);
                }else{
                    hide();
                }
            ...
            chooseButton.bind("click", function (e) {
                e.stopPropagation();
                e.preventDefault();
                ...
                //add cancel action to close spectrum dialog
        ...
        function updateUI() {
            ...
            var realColor = get();
            var realHex = (currentAlpha !== 0)? realColor.toHexString(): 'transparent';
...
(function (window) {
    ...
    tinycolor.equals = function (color1, color2) {
        ...
        if(tinycolor.validateTransparentColor(color1, color2)){
            var tiny1 = tinycolor(color1).toRgbString();
            var tiny2 = tinycolor(color2).toRgbString();
    ...
    tinycolor.validateTransparentColor = function(color1, color2){
