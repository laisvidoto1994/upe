    ...
    */
    onCellChange: function (renderColumn, cell, key) {
        ...
        if (self.properties.allowEdit || self.grid.bizagi_grid_tablet("isNewRecord", key)) {
            ...
            self.collectGridChange({ id: key, xpath: renderColumn.properties.xpath, value: _value, compositeValue: compositeValue, columnIndex: renderColumn.columnIndex, trigger: trigger });
        }
