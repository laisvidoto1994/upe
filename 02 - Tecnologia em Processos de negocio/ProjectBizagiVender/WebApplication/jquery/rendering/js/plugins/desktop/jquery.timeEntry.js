...
(function ($) { // Hide scope, no $ conflict
    ...
    $.extend(TimeEntry.prototype, {
        ...
        _connectTimeEntry: function (target, options) {
			...
			$('<span class="timeEntry_control" style="display: inline-block; bottom: 25%;' +
            ...
            input.wrap('<span class="timeEntry_wrap" style="display: inline-block; position: relative"></span>').
