...
def update_parameters(parameters, grads, learning_rate, m):   
    L = len(parameters) // 2 # number of layers in the neural network
    # Update rule for each parameter. Use a for loop.
    for l in range(L):
        parameters["W" + str(l+1)] = parameters["W" + str(l+1)] - parameters["W" + str(l+1)] * learning_rate*0.0/(2*m) - learning_rate * grads["dW" + str(l + 1)]
...
def L_layer_model(X, Y, layers_dims, learning_rate = 0.0075, num_iterations = 1000, print_cost=False):#lr was 0.009
    ...
    for i in range(0, num_iterations):
        ...
        parameters = update_parameters(parameters, grads, learning_rate, X.shape[1]) 
