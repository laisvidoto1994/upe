...
Classificador Logistic Regression sobre dados da KDDCUP'99 (4.898.431 observações, 41 dimensões)

Chamada: $ spark-shell --master spark://spark-node1:7077 --num-executors 2  --driver-memory 6G --executor-memory 4G  --executor-cores 4 -i KDD-LR.scala

Tempo de treino e teste: 183 segundos
